...
const navItems = [
    ...
    { path: '/teacher/leaves', label: 'Leave Approvals', icon: ClipboardList },
    { path: '/teacher/performance', label: 'Class Performance', icon: GraduationCap },
    { path: '/teacher/marks-entry', label: 'Marks Entry', icon: FileText },
        ...
        <div className="min-h-screen bg-slate-50 flex">
            ...
            <aside className="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col fixed h-full z-50">
                ...
                <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1 custom-scrollbar">
                    <p className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Faculty Portal</p>
                    {navItems.map((item) => (
                        <NavLink
                            key={item.path}
                            to={item.path}
